...
<svelte:head>
	<title>Theme — Read Flow</title>
</svelte:head>

<div class="max-w-2xl mx-auto px-4 py-6 md:px-6">
	<a
		href="/settings"
		class="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 mb-4 transition-colors"
	>
	...
	<p class="text-sm text-slate-400 dark:text-slate-500 mb-6">
		Customize the look of the app — modes, color schemes, and custom colors.
	</p>
