...
settings-theme-font-size = Taille de la police de l'interface
settings-theme-font-size-description = Taille en points. Prend effet après le redémarrage de l'application.
settings-theme-font-size-placeholder = Taille système
