...
shortcuts-elsewhere = Elsewhere
shortcuts-escape-back-or-close = Back / close (details, preferences, server log, image viewer)
shortcuts-open-this-panel = Open this panel
actions = Actions
context = Context
...
document-details-change-thumbnail = Change Thumbnail
document-details-change-thumbnail-tooltip = Choose a page to use as the thumbnail
...
document-details-thumbnail-margins = Exclude before cropping (e.g. a page number)
document-details-thumbnail-margin-top = Top: { $margin }px
document-details-thumbnail-margin-bottom = Bottom: { $margin }px
document-details-thumbnail-margin-left = Left: { $margin }px
document-details-thumbnail-margin-right = Right: { $margin }px
...
document-list-merge-candidate-summary = { $files } file(s) · { $tags } tag(s)
document-list-merge-candidate-tags = { $count } tags
document-list-merge-confirm = Merge
document-list-merge-confirm-body = "{ $winner }" will keep its metadata. { $count } other document(s) ({ $losers }) will be deleted; their files will be moved to "{ $winner }". This cannot be undone.
document-list-merge-title = Merge Documents
document-list-common-tags-label = On all selected
document-list-partial-tags-label = Also on some selected
document-list-partial-tag-remove-tooltip = Remove from the selected documents that have it
...
settings-language-description = Which language Read Flow displays in.
...
sources-submit-button = Save Source
...
settings-online-library-submit-catalog = Save Catalog
settings-online-library-delete-catalog-confirm-title = Remove Catalog
settings-online-library-delete-catalog-confirm-body = Are you sure you want to remove this catalog? This action cannot be undone.
settings-online-library-delete-catalog-confirm-remove = Remove
settings-remove-directory = Remove Directory
settings-remove-directory-confirm-body = Are you sure you want to remove this directory from scanning? This action cannot be undone.
settings-remove-directory-confirm-remove = Remove
...
settings-server-submit-authorized-user = Save Authorized User
settings-server-delete-authorized-user-confirm-title = Remove Authorized User
...
settings-theme-accent-description = Highlight color for buttons, links, and selections.
settings-theme-accent-blue = Blue
settings-theme-accent-indigo = Indigo
settings-theme-accent-purple = Purple
settings-theme-accent-pink = Pink
settings-theme-accent-red = Red
settings-theme-accent-orange = Orange
settings-theme-accent-yellow = Yellow
settings-theme-accent-green = Green
settings-theme-accent-warm-grey = Warm grey
settings-theme-accent-custom = Custom accent color
settings-theme-accent-default = Default
settings-theme-background = Window background
settings-theme-background-description = Base color behind all content. Leave unset to derive it from the appearance.
settings-theme-container-background = Container background
settings-theme-container-background-description = Color of cards, dialogs, and other containers.
settings-theme-contrast-warning = Low contrast: text may be hard to read on this background.
settings-theme-custom = Use custom theme
settings-theme-custom-description = Theme Read Flow without changing the COSMIC system settings.
settings-theme-dark = Dark
settings-theme-density = Density
settings-theme-density-description = Spacing between interface elements.
settings-theme-density-compact = Compact
settings-theme-density-standard = Standard
settings-theme-density-spacious = Spacious
settings-theme-font = Interface font
settings-theme-font-description = Font for menus, labels, and controls.
settings-theme-font-placeholder = System default
settings-theme-monospace-font = Monospace font
settings-theme-monospace-font-description = Font for code blocks and preformatted text.
settings-theme-monospace-font-placeholder = System default
settings-theme-frosted = Frosted glass
settings-theme-frosted-description = Translucent, blurred window background. Requires compositor blur support (COSMIC on Wayland).
settings-theme-frosted-strength = Frost strength
settings-theme-frosted-strength-low = Low
settings-theme-frosted-strength-medium = Medium
settings-theme-frosted-strength-high = High
settings-theme-light = Light
settings-theme-roundness = Roundness
settings-theme-roundness-description = How rounded corners of buttons and containers are.
settings-theme-roundness-round = Round
settings-theme-roundness-slightly-round = Slightly round
settings-theme-roundness-square = Square
settings-theme-section = Theme
settings-theme-variant = Editing
settings-theme-variant-description = Both a light and a dark look are saved at once; Read Flow switches between them automatically to match your system. Pick which one to edit below.
...
pdf-viewer-dual-page = Two-page spread
pdf-viewer-dual-page-auto = Auto
pdf-viewer-dual-page-off = Off
pdf-viewer-dual-page-on = On
...
pdf-viewer-open-in-action = Open
pdf-viewer-open-in-external = External viewer (system default)
pdf-viewer-open-in-section = Open in another viewer
...
image-viewer-keyboard-shortcuts = Keyboard shortcuts
image-viewer-shortcut-zoom-in = Zoom in
image-viewer-shortcut-zoom-out = Zoom out
image-viewer-shortcut-close = Close
...
epub-viewer-open-in-section = Open in another viewer
epub-viewer-open-in-mupdf = MuPDF viewer
epub-viewer-open-in-external = External viewer (system default)
epub-viewer-open-in-action = Open
...
epub-viewer-search-no-matches = No matches in this chapter
...
epub-viewer-shortcut-toggle-search = Toggle search
epub-viewer-shortcut-close-search = Close search
...
activity-summary = { $errors } failed · { $interrupted } interrupted
activity-error = { $message }
activity-loading = Loading activity…
activity-empty = Nothing recorded yet. Mutations and scans will appear here.
activity-select-hint = Select an operation to see its events, actor, and targets.
activity-details-title = Operation
activity-dry-run = Dry run
activity-detail-started = Started
activity-detail-completed = Completed
activity-detail-actor = Actor
activity-detail-channel = Channel
activity-detail-status = Status
activity-detail-error-code = Error code
activity-detail-counts = Counts
activity-detail-events = Events
activity-detail-no-events = No events recorded
activity-detail-related = History of related documents
...
activity-op-cover-edit = Change cover
activity-op-missing-file-maintenance = Missing-file maintenance
activity-channel-rest = HTTP API
activity-channel-cosmic = Desktop app
activity-channel-cli = Command line
activity-channel-internal = Internal
activity-actor-user = User { $id }
activity-actor-local = This device
activity-actor-local-session = This device (session)
activity-actor-system = System
activity-status-started = Started
activity-status-completed = Completed
activity-status-failed = Failed
activity-status-interrupted = Interrupted
activity-outcome-success = Success
activity-outcome-completed-with-errors = Completed with errors
activity-outcome-failed = Failed
activity-outcome-observed = Observed
activity-outcome-proposed = Proposed
...
activity-summary-cover-edit = Changed cover
activity-summary-missing-file-maintenance = Missing-file maintenance: { $counts }
