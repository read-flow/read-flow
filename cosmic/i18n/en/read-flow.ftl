...
settings-theme-font-size = Interface font size
settings-theme-font-size-description = Size in points. Takes effect after restarting the app.
settings-theme-font-size-placeholder = System default
