...
settings-server-delete-authorized-user = Delete Authorized User
settings-server-enter-user-id = Enter user ID...
settings-server-enter-passphrase = Enter passphrase...
