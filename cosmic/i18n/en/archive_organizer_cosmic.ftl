...
# File details
document-details-add = Add
document-details-basic-info = Basic Information
document-details-close = Close
document-details-enter = Enter a new tag
document-details-filename = Filename
document-details-fingerprint = Fingerprint
document-details-folder = Folder
document-details-full-path = Full Path
document-details-id = ID
document-details-loading-tags = Loading tags...
document-details-no-tags = No tags
document-details-open-file = Open File
document-details-remove-tag = Remove tag
document-details-select-status = Select status
document-details-select-tag = Select a tag
document-details-size = Size
...
# Tag filter
tag-filter-error = Failed to load tags
...
document-list-all-tags-in-use = All tags are already in use
document-list-allow-tags = Include Tags (must have ALL)
document-list-clear-all-tag-filters = Clear All Tag Filters
document-list-clear-filter = Clear Filter
document-list-deny-tags = Exclude Tags (must have NONE)
document-list-files-section = Files
...
document-list-sort-filename-asc = Filename (A-Z)
document-list-sort-filename-desc = Filename (Z-A)
document-list-sort-size-asc = Size (Smallest)
document-list-sort-size-desc = Size (Largest)
document-list-sort-status-asc = Status (Unread first)
...
settings-invalid-path = Invalid directory path
...
settings-server-authorization-tokens = Authorization Tokens
settings-server-add-authorization-token = Add Authorization Token
settings-server-delete-authorization-token = Delete Authorization Token
settings-server-enter-authorization-token = Enter authorization token...
