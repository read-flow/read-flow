...
document-details-change-thumbnail = Miniatuur wijzigen
document-details-change-thumbnail-tooltip = Kies een pagina om als miniatuur te gebruiken
...
document-details-thumbnail-padding = Binnenmarge: { $padding }px
document-details-thumbnail-margins = Uitsluiten voor het bijsnijden (bijv. een paginanummer)
document-details-thumbnail-margin-top = Boven: { $margin }px
document-details-thumbnail-margin-bottom = Onder: { $margin }px
document-details-thumbnail-margin-left = Links: { $margin }px
document-details-thumbnail-margin-right = Rechts: { $margin }px
...
document-list-merge-candidate-summary = { $files } bestand(en) · { $tags } label(s)
document-list-merge-candidate-tags = { $count } labels
document-list-merge-confirm = Samenvoegen
document-list-merge-confirm-body = "{ $winner }" behoudt zijn metadata. { $count } ander(e) document(en) ({ $losers }) worden verwijderd; hun bestanden worden verplaatst naar "{ $winner }". Dit kan niet ongedaan worden gemaakt.
document-list-merge-title = Documenten samenvoegen
document-list-common-tags-label = Op alle geselecteerde documenten
document-list-partial-tags-label = Ook op sommige geselecteerde documenten
document-list-partial-tag-remove-tooltip = Verwijderen van de geselecteerde documenten die dit label hebben
...
sources-submit-button = Bron Opslaan
...
settings-online-library-submit-catalog = Catalogus Opslaan
settings-online-library-delete-catalog-confirm-title = Catalogus Verwijderen
settings-online-library-delete-catalog-confirm-body = Weet je zeker dat je deze catalogus wilt verwijderen? Deze actie kan niet ongedaan worden gemaakt.
settings-online-library-delete-catalog-confirm-remove = Verwijderen
settings-remove-directory = Map Verwijderen
settings-remove-directory-confirm-body = Weet je zeker dat je deze map wilt verwijderen uit het scannen? Deze actie kan niet ongedaan worden gemaakt.
settings-remove-directory-confirm-remove = Verwijderen
...
settings-server-submit-authorized-user = Geautoriseerde Gebruiker Opslaan
settings-server-delete-authorized-user-confirm-title = Geautoriseerde Gebruiker Verwijderen
...
settings-theme-monospace-font = Monospace-lettertype
settings-theme-monospace-font-description = Lettertype voor codeblokken en voorgeformatteerde tekst.
settings-theme-monospace-font-placeholder = Systeemstandaard
...
pdf-viewer-dual-page = Dubbelzijdige weergave
pdf-viewer-dual-page-auto = Auto
pdf-viewer-dual-page-off = Uit
pdf-viewer-dual-page-on = Aan
...
pdf-viewer-open-in-action = Openen
pdf-viewer-open-in-external = Externe weergave (systeemstandaard)
pdf-viewer-open-in-section = Openen in een andere weergave
...
epub-viewer-search-no-matches = Geen resultaten in dit hoofdstuk
...
# Activity history
activity-page-title = Activiteit
activity-refresh = Verversen
activity-load-more = Meer laden
activity-summary = { $errors } mislukt · { $interrupted } onderbroken
activity-error = { $message }
activity-loading = Activiteit laden…
activity-empty = Nog niets vastgelegd. Wijzigingen en scans verschijnen hier.
activity-select-hint = Selecteer een bewerking om de gebeurtenissen, actor en doelen te bekijken.
activity-details-title = Bewerking
activity-dry-run = Proefdraaien
activity-detail-started = Gestart
activity-detail-completed = Voltooid
activity-detail-actor = Actor
activity-detail-channel = Kanaal
activity-detail-status = Status
activity-detail-error-code = Foutcode
activity-detail-counts = Tellingen
activity-detail-events = Gebeurtenissen
activity-detail-no-events = Geen gebeurtenissen vastgelegd
activity-detail-related = Geschiedenis van gerelateerde documenten
...
activity-op-cover-edit = Omslag wijzigen
activity-op-missing-file-maintenance = Ontbrekende bestandscontrole
activity-channel-rest = HTTP-API
activity-channel-cosmic = Desktop-app
activity-channel-cli = Opdrachtregel
activity-channel-internal = Intern
activity-actor-user = Gebruiker { $id }
activity-actor-local = Dit apparaat
activity-actor-local-session = Dit apparaat (sessie)
activity-actor-system = Systeem
activity-status-started = Gestart
activity-status-completed = Voltooid
activity-status-failed = Mislukt
activity-status-interrupted = Onderbroken
activity-outcome-success = Geslaagd
activity-outcome-completed-with-errors = Voltooid met fouten
activity-outcome-failed = Mislukt
activity-outcome-observed = Waargenomen
activity-outcome-proposed = Voorgesteld
...
activity-summary-cover-edit = Omslag gewijzigd
activity-summary-missing-file-maintenance = Ontbrekende bestandscontrole: { $counts }
