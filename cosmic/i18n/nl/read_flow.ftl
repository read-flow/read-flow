...
file-list-files-section = Bestanden
...
file-list-new = Nieuw
file-list-no-files = Geen bestanden voldoen aan de huidige filters
...
document-details-full-path = Volledig pad
document-details-id = ID
document-details-loading-tags = Tags laden...
document-details-no-tags = Geen tags
document-details-open-file = Bestand Openen
document-details-remove-tag = Tag verwijderen
document-details-select-status = Selecteer status
document-details-select-tag = Selecteer een tag
document-details-size = Grootte
document-details-size-bytes = { $size } bytes
document-details-status = Status
document-details-tags = Tags
document-details-technical = Technische details
document-details-type = Type
document-details-unknown = Onbekend

# Tag editor
tag-editor-add = Toevoegen
tag-editor-enter = Nieuwe tag invoeren
...
# Tag filter
tag-filter-error = Tags laden mislukt
tag-filter-loading = Tags laden...

# Document details
document-details-available-everywhere = Document is beschikbaar op alle bronnen
...
document-list-all-tags-in-use = Alle tags zijn al in gebruik
document-list-allow-tags = Tags insluiten (moet ALLE hebben)
document-list-clear-all-tag-filters = Alle tagfilters wissen
document-list-clear-filter = Filter wissen
document-list-deny-tags = Tags uitsluiten (mag GEEN hebben)
document-list-files-section = Bestanden
...
document-list-filters-section = Filters
document-list-loading = Laden
document-list-new = Nieuw
...
settings-invalid-path = Ongeldig map pad
...
settings-server-delete-authorized-user = Geautoriseerde Gebruiker Verwijderen
