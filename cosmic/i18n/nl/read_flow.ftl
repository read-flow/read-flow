...
document-details-metadata-section = Documentinformatie
document-details-metadata-title = Titel
...
document-details-fingerprint = Document ID
...
document-list-pick-format-title = Kies formaat
